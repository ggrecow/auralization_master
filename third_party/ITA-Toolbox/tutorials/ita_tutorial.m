...
[signal,fs] = audioread(C:\Users\greco\Desktop\SQAT_PANAM\Auralized_PANAM_immision_64bit.wav);

s.samplingRate = fs;
s.comment = 'auralized aircraft';
s.channelNames{1} = 'auralized aircraft2';
s.trackLength =
s.time = signal;
