...
%  -------------------------------------------------------------------------------
%
%  File:    generateIRDatabaseOmniFig8.m
%  Purpose: Example Matlab script that shows how to create a 
%           DAFF HRIR database containing one omni and one fig8-channel
%  Author: Lukas Aspöck (Lukas.Aspoeck@akustik.rwth-aachen.de)
%
%  $Id: $
%
...
%  About:
%
%  This script generates a two-channel IR dataset.
...
%
%  Here we create a 3x3° resolution equiangular sphere grid with two
%  channels.
%

dataset = daffv15_create_dataset('alphares', 3, ...
                              'betares', 3, ...
                              'channels', 2)
...
dataset.metadata.delay_samples = int32(31); % so to 31 delay samples
...
daffv15_write('filename', 'Receiver_IR_2ch_Omni+Fig8_ds31_3x3.daff', ...
           'content', 'IR', ...
