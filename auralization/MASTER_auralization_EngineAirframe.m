...
nfft = 2^14; % to yield df=3 Hz (if fs=48 kHz). needs to be fine, otherwise ground reflection effects are not well described
...
if binaural_signal == 1 % <- binaural truncated to zero for engineSignal and airframeSignal 
